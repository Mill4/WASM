...
namespace WasmDemoApp.Pages
{
    public class IndexBase : ComponentBase
    {
        string[] pokemons = new string[] {"Bulbasaur", "Ivysaur", "Venusaur", "Charmander",
        ...
        protected override void OnInitialized()
        {
            ...
            while (size < 1025)
            {
                ...
                var milliseconds = programtimer.Elapsed.TotalMilliseconds;

                Console.WriteLine("Time elapsed in array size " + size + " : " + milliseconds);
                size = size * 2;
                // take time
            }

           /* IterateSearchFunction(100);
            IterateSearchFunction(10000);
            IterateSearchFunction(100000);
            IterateSearchFunction(500000); */

            base.OnInitialized();
        }

        public int SearchNumberOfAsFromPokemons(string[] pokemons)
        {
            int counter = 0;
        ...
        public void ijk(int[,] matrixA, int[,] matrixB, int[,] matrixC, int length)
        {
        ...
        public void IterateSearchFunction(int iterations)
        {
            Stopwatch iterationTimer = new Stopwatch();
            iterationTimer.Start();
            for (int i = 0; i < iterations; i++)
            {
                var res = SearchNumberOfAsFromPokemons(pokemons);
            }
            iterationTimer.Stop();
            Console.WriteLine("Time elapsed in " + iterations + " iterations: " + iterationTimer.Elapsed.TotalSeconds);
        }
    }
}
